...
type User struct {
	...
	IsAdmin      bool           `gorm:"column:is_admin;not null;default:false" json:"is_admin"` // Deprecated: use Role instead
	Preferences  datatypes.JSON `gorm:"column:preferences;type:jsonb;default:'{}';not null" json:"preferences"`
