...
func (s *Server) Init() error {
	...
	routers := []router.Router{
		auth.NewRouter(),      // Authentication routes
		container.NewRouter(), // Container management routes
		task.NewRouter(),      // Task management routes
		image.NewRouter(),     // Image management routes
	}

	// Initialize engine with routers
	s.engine = router.InitRouter(routers)
